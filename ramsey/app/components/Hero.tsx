...
const Hero = () => {
  ...
  return (
    <div className="hero bg-primary-tan px-36 max-w-full max-h-screen">
      <div className="grid grid-cols-2 gap-4 gap-x-0 pt-40 py-4 px-1 border-2 border-black-100 max-w-6xl mt-5 items-top max-h-128">
        <div className="hero__text">
          ...
          <p className="hero__subtitle -ml-24">
            When was the last time you cooked a great pasta that tasted better
            than it looked.
          </p>
      ...
      <div className="banner bg-gray-300 shadow-lg flex items-center justify-center"></div>
    </div>
  );
};
